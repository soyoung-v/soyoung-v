...
<p align="center">
  Java & Spring Boot 기반 백엔드 개발자를 목표로 공부하고 있습니다.<br>
  MSA, Kafka, JPA, Vue를 활용한 웹 서비스 프로젝트를 진행하며<br>
  기능 구현뿐 아니라 구조 설계와 문제 해결 과정을 함께 기록하고 있습니다.
</p>
...
- Java / Spring Boot 기반 백엔드 개발을 중심으로 역량을 쌓고 있습니다.
- Vue.js를 활용한 프론트엔드 구현 경험도 함께 쌓고 있습니다.
- 주거관리 시스템, SNS 서비스, 공공 API 기반 여행 서비스 등 다양한 프로젝트를 진행했습니다.
- 프로젝트를 진행하며 요구사항 명세서, API 명세서, ERD, 트러블슈팅 기록을 함께 정리하고 있습니다.
